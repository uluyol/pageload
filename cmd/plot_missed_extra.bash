...
cat results/missed_extra/sites/*/missed-server > "$TMP/missed/server"
cat results/missed_extra/sites/*/extra-server > "$TMP/extra/server"
...
"$TOPDIR/cdfs.R" "$missed_pdf_path" "Fraction of Predictable Set" 0,0.25,0.5,0.75,1 "$TMP/missed"/*
